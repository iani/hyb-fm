...
var window = Window.new("HybFM",Rect(605, 601, 1200, 800)).front;
		...
		view.keyDownAction = { |doc, char, mod, unicode, keycode, key|
			["ON", doc, char, mod, unicode, keycode, key].postln;
			~keyOn.(nil, 0, char.ascii, 80);
		};

		view.keyUpAction = { |doc, char, mod, unicode, keycode, key|
			["OFF", doc, char, mod, unicode, keycode, key].postln;
			~keyOff.(nil, 0, char.ascii, 0);
		};
